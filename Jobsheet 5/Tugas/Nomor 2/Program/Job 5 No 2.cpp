...
int main() {
    ...
    sisipkanAkhir(&head, "AB 1234 CD", "Toyota", "Asep");
    sisipkanAkhir(&head, "BA 4321 DC", "Honda", "Panjul");
    sisipkanAkhir(&head, "B 1357 CA", "Nissan", "Gema");

    // Menampilkan daftar mobil dalam antrian
    tampilkanAntrian(head);

    // Menghapus sebuah mobil dari antrian berdasarkan nomor plat
    hapusBerdasarkanPlat(&head, "BA 4321 DC");
